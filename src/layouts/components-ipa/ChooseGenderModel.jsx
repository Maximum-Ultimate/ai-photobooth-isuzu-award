...
import maleGender from "../../assets/img-ipa/maleGender.webp";
import maleGenderCliicked from "../../assets/img-ipa/maleGenderClicked.webp";
import femaleGender from "../../assets/img-ipa/femaleGender.webp";
import femaleGenderClicked from "../../assets/img-ipa/femaleGenderClicked.webp";
import backgroundButton from "../../assets/img-ipa/buttonIdle.webp";

// Models
import maleModelImg1 from "../../assets/img-ipa/male1.png";
import maleModelImg2 from "../../assets/img-ipa/male2.png";
import maleModelImg3 from "../../assets/img-ipa/male3.png";
import femaleModelImg1 from "../../assets/img-ipa/female1.png";
import femaleModelImg2 from "../../assets/img-ipa/female2.png";
import femaleModelImg3 from "../../assets/img-ipa/female3.png";
...
export default function ChooseGenderModel() {
  ...
  const confirmSelection = (modelId) => {
    ...
    setTimeout(() => {
      ...
      navigate(
        `/take-photo-ai-ipa?gender=${selectedGender()}&modelId=${modelId}`,
      );
    }, 400);
  };
